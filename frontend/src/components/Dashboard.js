...
const Dashboard = () => {
  ...
  const cards = [
    ...
    {
      title: 'Users',
      description: 'Stay informed with a full history of Users interactions and touchpoints',
    ...
    {
      title: 'Tasks',
      description: 'Create, assign, and prioritize tasks. Monitor task status and ensure timely completion.',
